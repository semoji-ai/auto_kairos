...
**첫째가 먼저입니다.** 길이만 보고 가르면 혼자 설 수 없는 문장이 홀로
남습니다. 그려 놓고 보면 「인물만 서 있을 뿐 말이 화면에 없는」 컷이 됩니다.

## 첫째 — 혼자서 한 장면이 되는가

**가리키는 사물이나 동작이 있는가**를 보세요.

  선다      종업원은 스무 명 남짓
            기계는 그해 8월 무렵에야 들어왔습니다
            상인들은 공장 앞에 줄을 섰습니다

  안 선다   확실한 것은 이겁니다 · 문제가 있었습니다 · 순서가 흥미롭습니다
            공식 어록에는 이런 말이 있습니다        ← 다음 말을 여는 문장
            그래서 불량품을 고치려 한 게 아니었습니다  ← 부정문
            납품처를 탓했다면 비용으로 끝났을 겁니다   ← 가정문

**부정문과 가정문이 특히 그렇습니다.** 「고치려 한 게 아니었다」는 하지 않은
일을 말하는데, 그림은 하지 않은 일을 그릴 수 없습니다. 무엇을 했는지가 뒤
문장에 있으니 함께 두어야 화면이 섭니다.

→ 안 서는 문장은 **뒤 문장과 묶습니다. 60자를 넘어도 묶습니다.**
