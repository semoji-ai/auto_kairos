...
## 붙이는 경우는 이것뿐입니다
  ...
  · 앞 문장이 뒤 문장을 **여는 말**일 때. 「확실한 것은 이겁니다」·「순서가
    흥미롭습니다」·「문제가 있었습니다」·「이런 말이 있습니다」처럼
    **혼자서는 한 장면이 되지 못하는** 문장입니다.
    부정문(「~한 게 아니었습니다」)과 가정문(「~했다면 ~했을 겁니다」)도
    그렇습니다 — 그림은 하지 않은 일을 그릴 수 없으니, 무엇을 했는지가
    적힌 뒤 문장과 함께 두어야 화면이 섭니다.
    **이 경우는 60자를 넘어도 묶습니다.**

**붙여도 두 문장까지입니다. 셋은 안 됩니다.**
붙인 결과가 **60자를 넘으면 붙이지 마세요.** (여는 말은 예외입니다)

## 스스로 물어볼 것

문장마다 **「이 문장 혼자서 한 장면이 되는가」**를 물으세요. 가리키는 사물도
동작도 없으면 혼자 세우지 마세요.
