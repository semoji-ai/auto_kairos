...
**먼저 볼 것: 이 문장이 가리키는 사물이나 동작이 있는가.**

없으면 무조건 `continuous` 입니다. 「확실한 것은 이겁니다」·「문제가
있었습니다」·「순서가 흥미롭습니다」처럼 다음 말을 여는 문장, 그리고
「~한 게 아니었습니다」 같은 부정문, 「~했다면 ~했을 겁니다」 같은
가정문이 여기 듭니다. 그림은 **하지 않은 일을 그릴 수 없습니다.**

이런 문장에 새 장면을 지으면 「인물만 서 있을 뿐 말이 화면에 없는」 컷이
나옵니다. 앞 컷의 세계를 이어받아 카메라만 움직이세요.
