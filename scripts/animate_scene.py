...
**움직여야 하는 것**과 **그 앞을 가리는 것**만 가릅니다. 그 외에는 전부
배경 한 장입니다. 가구·소품·창문은 하나하나 떼지 않습니다 — 움직이지도
가리지도 않는 것을 떼면 층만 늘고 얻는 것이 없습니다.

가르는 이유는 셋뿐입니다.

1. **움직인다** — 사람, 또는 나타났다 사라져야 하는 물건
2. **가린다** — 움직이는 것의 앞을 지나간다. 함께 두면 그것이 움직일 때
   가려져 있던 부분이 드러납니다
3. **내레이션이 가리킨다** — 그것만 나타나거나 강조되어야 합니다
...
큰 가구를 조심하세요. **탁자는 사람보다 앞이지만, 그 위에 놓인 물건보다는
뒤입니다.** 상판이 물건을 덮으면 안 됩니다.

## 이름은 영어로

층 이름은 **영어**로 씁니다. 무엇인지 그대로 적으면 됩니다.
...
텔레비전·책장·화분은 배경에 두었습니다. 움직이지도 가리지도 않기 때문입니다.
...
`is_person`은 **움직이는 층**에 표시합니다(사람과 그 부위).
"""
