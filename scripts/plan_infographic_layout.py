...
도해의 요소로 **사람을 그리라고 적지 마세요.** 첨부된 기준 캐릭터 시트를
베껴 같은 얼굴이 둘 나옵니다 — 구인회와 허준구가 쌍둥이로 나온 적이 있습니다.

사람이 하는 일은 **물건으로 가릅니다.**

  구씨는 생산, 허씨는 자금  →  사출기와 제품 상자  |  장부와 주판과 궤짝
  두 집안이 이어졌다        →  붉은 끈 두 가닥이 하나로 묶인 매듭

사람이 꼭 필요한 자리면 그건 도해가 아니라 **재연 씬**입니다.
