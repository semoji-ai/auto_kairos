...
> ### 📌 읽기 전에 (2026-09-08 덧붙임)
>
> **이 문서는 이관이 끝난 뒤의 기록이고, 경로는 특정 머신 것입니다.**
> 아래에 나오는 `~/LocalProjects/auto_kairos` 별칭 심링크와
> `/Volumes/jleavens/…` 는 `jleavens_macmini` 의 설정입니다. 다른 머신에는
> 그런 경로가 없을 수 있으니 그대로 따라 하지 마시고, **본인 머신의 저장소
> 경로로 바꿔 읽으세요.**
>
> 이관 자체는 완료됐습니다. 표준 저장소(`semoji-ai/auto_kairos_adobe`)는
> 2026-09-08 에 읽기전용으로 봉인됐습니다.
