...
RULE_MANIFEST = {
    ...
    "skills/shared/narrative-semoji.md": "skill",
    "skills/shared/narrative-iromism.md": "skill",
    "skills/shared/voice-semoji.md": "skill",
    "skills/shared/voice-iromism.md": "skill",
