...
모든 라운드 완료 후, 아래 형식으로 결과를 저장하세요:

1. **insights/planning/{today}-{self._channel}-autoresearch.json** — 구조화된 후보 데이터
```json
{{
  "date": "{today}",
...
2. **insights/planning/{today}-{self._channel}-기획안.md** — 상위 3개 기획안 (마크다운)
